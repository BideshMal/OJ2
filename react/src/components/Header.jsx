  ...
  return (
    ...
    <div className='flex justify-between items-center max-w-6xl mx-auto p-3'>
        ...
        <h1 className='font-bold text-sm sm:text-xl flex flex-wrap'>
            <span className='text-slate-500'> Online Judge</span>
            <span className='text-slate-700'> by Bidesh</span>
        </h1>
        </Link>
        ...
        <form className='text-black-700 bg-slate-100 p-3 rounded-lg flex items-center' >
            <input type="text" placeholder='Search Problems' className='bg-transparent focus:outline-none w-24 sm:w-64 md:w-40'/>
